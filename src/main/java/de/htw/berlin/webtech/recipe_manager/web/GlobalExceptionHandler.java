...
public class GlobalExceptionHandler {
    ...
    // 404/…: exakt die Statuscodes einer ResponseStatusException respektieren
    ...
    // 400: JSON nicht lesbar (z. B. falscher Typ)
    ...
    // 400: unwrap transaktionale Wrapper (z. B. IllegalArgumentException in @Transactional)
    ...
    public ResponseEntity<Map<String, Object>> handleDataIntegrity(
        ...
        return resp(HttpStatus.CONFLICT, "Data integrity violation", request, null);
    }
